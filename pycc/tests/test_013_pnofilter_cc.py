"""
Test basic PNO-CCSD energy and Lambda code using local filter
"""
...
def test_pnofilter_ccsd():
    """H2O PNO-CCSD Test using local filter"""
    # Psi4 Setup
...
def test_pnofilter_ccsd_opt():
    """H2O PNO-CCSD Test with Optimized Initial T2 Amplitudes using local filter"""
    # Psi4 Setup
    psi4.set_memory('2 GB')
    psi4.core.set_output_file('output.dat', False)
    psi4.set_options({'basis': 'cc-pVDZ',
