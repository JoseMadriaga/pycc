"""
Test basic PAO-CCSD energy using local filter
"""
...
def test_pao_H8():
    """PAO-CCSD Test using local filter"""
    # Psi4 Setup
...
def test_pao_h2o():
    """PAO-CCSD Test 2 using local filter"""
    # Psi4 Setup
    psi4.set_memory('1 GB')
    psi4.core.set_output_file('output.dat', False)
...
def test_pao_h2o_frzc():
    """PAO-CCSD Frozen Core Test using local filter"""
    # Psi4 Setup
    psi4.set_memory('1 GB')
    psi4.core.set_output_file('output.dat', False)
    psi4.set_options({'basis': '6-31g',
