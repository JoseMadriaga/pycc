...
def test_linresp():
    ...
    cc = pycc.ccwfn(rhf_wfn, local_mos = 'BOYS', local = 'PNO', local_cutoff= 0, filter=True) #, it2_opt= False) #, it2_opt = False)
    ...
    omega1 = 0.0656 #0.077357135#0.0656
